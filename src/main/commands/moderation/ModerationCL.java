...
public class ModerationCL {
  ...
  public static void init() {
    ...
    ChatCommands.commandMap.put("quote", (MessageReceivedEvent event, List<String> args) -> {
      ...
      e.withFooterText(
        msg.getTimestamp().toLocalDate().format(DateTimeFormatter.ofPattern("dd-MM-yyyy")) + "@" + msg.getTimestamp().toLocalTime().format(DateTimeFormatter.ofPattern("HH:mm")) + " in #" + msg.getChannel().getName());
